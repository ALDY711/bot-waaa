// Space Rush 🚀 - WhatsApp Meta AI Interactive HTML5 Canvas Mini Game
const fs = require('fs');
...
async function sendSpaceRush(sock, chatId, quoted = null) {
  ...
  const messagePayload = {
    messageContextInfo: {
      ...
      botMetadata: {
        ...
        invokerJid: quoted?.key?.participant || quoted?.key?.remoteJid || null,
  ...
  return await sock.relayMessage(chatId, messagePayload, quoted ? { quoted } : {});
}
